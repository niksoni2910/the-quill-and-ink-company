...
"[project]/app/admin/products/create/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CreateProductPage() {
    ...
    const createCategory = async ()=>{
        ...
        const category = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/categories", "POST", {
            name: newCategory,
            slug
        }, token);
        setCategories((prev)=>[
    ...
    const handleSubmit = async ()=>{
        if (!form.name || !form.price || !form.categoryId || !images.length) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("All fields required");
            return;
        }
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/products", "POST", {
            name: form.name,
...
_s(CreateProductPage, "zOUFlc1ndtezc7f5BDgCT4mvEGk=", false, function() {
    return [
...
//# sourceMappingURL=_e147246e._.js.map