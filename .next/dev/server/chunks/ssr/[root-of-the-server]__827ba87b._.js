...
function LoginPage() {
    ...
    const handleLogin = async ()=>{
        if (!email || !password) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error("Please enter email and password");
            return;
        }
        try {
            setLoading(true);
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])("/auth/login", "POST", {
                email,
                password
            });
            login(res.token);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__827ba87b._.js.map